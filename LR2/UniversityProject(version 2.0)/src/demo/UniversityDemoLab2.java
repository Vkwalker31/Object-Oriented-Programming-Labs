...
public class UniversityDemoLab2 {
    public static void main(String[] args) {
        System.out.println("═══════════════════════════════════════════════════════════════");
        System.out.println("  ЛР2: Наследование, композиция, полиморфизм");
        System.out.println("═══════════════════════════════════════════════════════════════\n");

        System.out.println("1. Создание университета:");
        System.out.println("─────────────────────────────────────────────────────────────");
        ...
        System.out.println("2. Создание факультетов:");
        System.out.println("─────────────────────────────────────────────────────────────");
        ...
        System.out.println("4. Создание преподавателей:");
        System.out.println("─────────────────────────────────────────────────────────────");
        ...
        System.out.println("6. Создание различных типов курсов (полиморфизм):");
        System.out.println("─────────────────────────────────────────────────────────────");

        LectureCourse courseOS = new LectureCourse("PROG101", "Операционные среды", 4, 30, "Лекционный зал 1");
        LectureCourse courseAlgo = new LectureCourse("ALGO201", "Алгоритмы и структуры данных", 4, 25, "Лекционный зал 2");
        LabCourse courseBCN = new LabCourse("PROG102", "Основы компьютерных сетей", 3, 20, 15, true);
        ...
        courseOS.setSchedule(new Schedule("MONDAY", LocalTime.of(10, 0), LocalTime.of(12, 0), room_104));
        courseAlgo.setSchedule(new Schedule("WEDNESDAY", LocalTime.of(14, 0), LocalTime.of(16, 0), room_405));
        courseBCN.setSchedule(new Schedule("FRIDAY", LocalTime.of(9, 0), LocalTime.of(11, 0), room_111));
        ...
        System.out.println("Демонстрация полиморфизма через AbstractCourse:");
        List<AbstractCourse> allCourses = new ArrayList<>();
        allCourses.add(courseOS);
        allCourses.add(courseAlgo);
        allCourses.add(courseBCN);

        for (AbstractCourse course : allCourses) {
            System.out.println("  - Курс: " + course.getName() + " (Тип: " + course.getCourseType() + ")");
            System.out.println("    ID: " + course.getId() + ", Мест: " + course.getCurrentOccupancy() + "/" + course.getMaxCapacity());
            if (course instanceof LectureCourse) {
                LectureCourse lc = (LectureCourse) course;
                System.out.println("    Лекционный зал: " + lc.getLectureHall());
            } else if (course instanceof LabCourse) {
                LabCourse lbc = (LabCourse) course;
                System.out.println("    Компьютеры: " + lbc.getNumberOfComputers() + ", ПО: " + lbc.requiresSpecialSoftware());
            }
        }
        System.out.println();
        ...
        System.out.println("9️⃣  Выставление оценок:");
        System.out.println("─────────────────────────────────────────────────────────────");
        ...
        System.out.println("1️⃣0️⃣  Итоговая информация:");
        System.out.println("─────────────────────────────────────────────────────────────");
        ...
        System.out.println("\nИнформация о курсах:");
        System.out.println("  • " + courseOS + " - занято: " + courseOS.getCurrentOccupancy() + "/" +
                courseOS.getMaxCapacity());
        System.out.println("  • " + courseAlgo + " - занято: " + courseAlgo.getCurrentOccupancy() + "/" +
                courseAlgo.getMaxCapacity());
        System.out.println("  • " + courseBCN + " - занято: " + courseBCN.getCurrentOccupancy() + "/" +
                courseBCN.getMaxCapacity());
        ...
        System.out.println("\n═══════════════════════════════════════════════════════════════");
        System.out.println("  ✓ Демонстрация ЛР2 завершена успешно");
        System.out.println("═══════════════════════════════════════════════════════════════");
    }
}
